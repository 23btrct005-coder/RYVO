            ...
            isSheetMinimized ? (
              ...
              <>
                ...
                <div className="flex items-center justify-between mb-4">
                  <p className="text-zinc-400 text-sm font-medium">Where to?</p>
                  ...
                  <button
                    ...
                    className="flex items-center space-x-1.5 px-3 py-1.5 rounded-full bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 font-extrabold text-xs transition active:scale-95 shadow-sm"
                  >
